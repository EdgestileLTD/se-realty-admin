...
imagemanager
    ...
    .filemanager__body(onclick='{ unselectAllItems }', ontouchmove='{ bodyScroll }')
        ...
        class='{ filemanager__file_selected: __selected__ }')
            .filemanager__file-icon(if='{ isDir }')
                i.fa.fa-folder-o.fa-4x
            .filemanager__file-icon(if='{ !isDir }', style="background-image: url({ urlPreview })", ondblclick='{ dblclick }')
    ...
    script(type='text/babel').
        ...
        self.dblclick = e => {
            if ('dblclick' in opts && typeof(opts.dblclick) === 'function') {
                opts.dblclick.bind(this, e)()
            }
            //alert('ssss')
        }
